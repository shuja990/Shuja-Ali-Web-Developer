...
function sendEmail(e) {
  ...
  return (
	    ...
	    <form className="contact-form back pa4 pt0 white-80 tc ba b--dark-gray bw2" onSubmit={sendEmail}>
			...
			<input id="user_email" name="user_email" aria-label="Email"
			className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-60" 
			required 
			type="email" 
			aria-describedby="name-desc"/>
			<label className="f4 b db  pa2 mb2">Message</label>
	    	<input required type="text" id="comment" aria-label="Message" name="message" className="b pa2 pb4 input-reset ba bg-transparent hover-bg-black hover-white w-60" 
