...
const Header = ({showContactComponent}) => {
	...
	<div className="full flex container2 align center pa0 ma0 ">
			...
			<img src={logo} className="pointer grow" alt="Shuja Ali" height="250px"/>
			<div className="">
